  ...
  <!-- Copyright (c) 2017, Software AG  All Rights Reserved. -->
	...
	<body>
		...
		<table width=100% class="tableView">
			...
			<tr>
				<td class="heading" colspan=7>Encrypted Values</td>
			</tr>
			<tr class="subheading2">
				...
				<td class="oddcol"   width="6%" tdclass="rowdata-l" sortable="false" type="CaseInsensitiveString" style="cursor: hand;"               >&nbsp;Encrypted Value&nbsp;</td>
